          ...
          <div class="container">
            ...
            <div class="dashboard-content">
              <div class="card mb-2 shadow p-3 bg-light rounded">
                <div class="card-body">
                  <form action="{{ route('member-next-investor-save') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                      <p class="text-muted">Apakah Anda investor / pemodalnya ?</p>
                      <div
                    ...
                    <div class="form-group" v-if="is_investor == false">
                     <label>Nama Investor / Pemodal</label>
