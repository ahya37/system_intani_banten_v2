          ...
          <div class="container">
            ...
            <div class="dashboard-content">
              <div class="card mb-2 shadow p-3 bg-light rounded">
                <div class="card-body">
                    <h5 class="mb-3">Pengelola</h5>
                  <form action="{{ route('member-management-save') }}" method="POST" enctype="multipart/form-data" id="register">
                    @csrf
                    <div class="form-group">
                      <p class="text-muted">Jenis Pengelola ?</p>
                      <div
                       class="custom-control custom-radio custom-control-inline"
                     >
                     <input type="hidden" name="agricultur_group_id" value="{{ $id }}">
                       <input
                         type="radio"
