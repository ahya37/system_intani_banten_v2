          ...
          <div class="container">
            ...
            <div class="dashboard-content">
              <div class="card mb-2 shadow p-3 bg-light rounded">
                <div class="card-body">
                    <h5 class="mb-3">Investor / Pemodal</h5>
                  <form action="{{ route('member-investor-save') }}" method="POST" enctype="multipart/form-data" id="register">
                    @csrf
                   ...
                   <div class="form-group">
                     ...
                     <input type="hidden" name="agricultur_group_id" value="{{ $agricultur_group_id }}">
